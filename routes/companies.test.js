...
describe("GET /companies", function () {
  ...
  test("bad request if invalid filter key", async () => {
    const resp = await request(app)
      .get("/companies")
      .query({ minEmployees: 2, nothing: "nothing" });
  ...
  test("works for anon", async function () {
    ...
    expect(resp.body).toEqual({
      company: {
        ...
        logoUrl: "http://c1.img",
        jobs: [
          { id: testJobsIds[0], title: "J1", equity: "0.1", salary: 1 },
          { id: testJobsIds[1], title: "J2", equity: "0.2", salary: 2 },
          { id: testJobsIds[2], title: "J3", equity: null, salary: 3 },
        ],
      },
    });
  });
